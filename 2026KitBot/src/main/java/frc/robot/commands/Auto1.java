...
public class Auto1 extends SequentialCommandGroup {
    ...
    public Auto1(CANDriveSubsystem driveSubsystem, CANFuelSubsystem ballSubsystem, VisionSubsystem visionSubsystem, double angle1, double angle2, double distance, double speed){
        
        visionSubsystem.getAutoPose().getX();
